...
await page.click("a:has-text('detect · PP-DocLayoutV2')");
...
const first = await page.locator(".sheet svg rect >> nth=0").boundingBox();
const img = await page.locator(".sheet img").boundingBox();
console.log("first box top within image:", ((first.y - img.y) / img.height).toFixed(3), "of the image height");
