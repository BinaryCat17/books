...
export type SeriesRow = { id: number; store: string; book: string; kind: string; label: string; metric: string; version: number; identity: string | null; source_sha256: string | null; truth_sha256: string | null; when: number; pages: number[] | null; scalars: Record<string, Scalar>; params: Record<string, unknown>; state: string };
