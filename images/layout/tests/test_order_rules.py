...
import shutil
import support
from backend import contour as metrics
from backend import order
from backend import docling as docling_heron
...
def _fake_page(rows, labels):
    ...
    import cv2
    import tempfile
    from backend.doclayout import DocLayout
    ...
    tmp = tempfile.mkdtemp(prefix="backend-order-")
