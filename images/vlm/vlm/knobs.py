...
KNOBS = (
    ...
    Knob(
        "LAYOUT_ENDPOINT",
        "",
        "address of a served layout or hybrid model, the root its /vlm routes hang from; read by the served adapter, and by the doctor to know whether there is one to ask; no default",
    ),
    Knob(
        "YOLOX_WEIGHTS",
        "",
