...
книгу на перевод или пересказ, написано в `docs/prompt.md` — файл целиком
вставляется в начало разговора как готовый промт. Правила в нём общие для
любого скана и ничего не знают о конкретной книге — что это за издание и чем
опасна ошибка, скажите модели сами. Замеры по нашей книге — в
`docs/ocr-notes.md`.
