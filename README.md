...
Готовый промт для модели, которая будет переводить или пересказывать книгу, —
в `docs/prompt.md`: его можно вставлять как есть, там же добавки отдельно под
перевод и под пересказ.
