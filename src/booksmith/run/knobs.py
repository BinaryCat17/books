...
Механизм перенесён из прежнего `jobs/paddleocr/entrypoint.py` — он один из
немногих, кто себя оправдал: поймал `VL_MODEL_DIR`, ручку, решавшую, какие
веса поднимет vLLM, и не попадавшую в слепок прогона. Правила те же:
